...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-8">
            <form class="form-horizontal" id="tea_ForgetPass" >
                <input type="hidden" name="flag" value="2">
                <div class="form-group">
                    <label for="teaPhone" class="col-sm-2 control-label">手机号</label>
                    <div class="col-sm-10">
                        <input type="tel" class="form-control" id="teaPhone" name="teaPhone" placeholder="请输入手机号">
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-default" id="tea_Forget">确定</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        $("#tea_Forget").click(function () {
            if ($("#teaPhone").val() == ""){
                ...
                $.ajax({
                    ...
                    type:"post",
                    dataType:"json",
                    data:$("#tea_ForgetPass").serialize(),
                    success:function (data) {
                        if (data.flag == "true"){
                            location.href = "teacher/reset?teaPhone="+data.message;
                        }else {
                            alert("号码输入有误");
                        }
                    }
