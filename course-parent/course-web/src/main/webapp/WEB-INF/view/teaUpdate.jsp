...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8">
    <form class="form-horizontal" method="post" action="teacher/updateSelfs">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" name="name" value="${teacher.name}" placeholder="请输入教师姓名">
            </div>
        </div>
        <div class="form-group">
            <label for="stuPhone" class="col-sm-2 control-label">联系方式</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="stuPhone" name="stuPhone" value="${teacher.teaPhone}" placeholder="请输入教师联系方式">
            </div>
        </div>
        <div class="form-group">
            <label for="selfdescn" class="col-sm-2 control-label">自我描述</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="selfdescn" name="selfdescn" value="${teacher.selfdescn}" placeholder="请输入描述">
            </div>
        </div>
        <div class="form-group">
