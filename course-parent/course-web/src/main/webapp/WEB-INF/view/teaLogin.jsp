...
<div class="container">
    <div class="row" >
        <div class="page-header">
            <h1>WEB课程资源库系统<small>教师登录</small></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <form id="tea_login">
                ...
                <div class="form-group">
                    <a href="skip/skipTeaForgetPass">忘记密码？</a>
                </div>
                <div class="checkbox">
                    <label>
                ...
                <button type="button" class="btn btn-default"><a href="skip/skipTeaRegister" style="text-decoration: none">注册</a></button>
   ...
   <script>
       $("#login").click(function () {
           $.ajax({
               ...
               type:"post",
               dataType:"json",
               data:$("#tea_login").serialize(),
               success:function(data) {
                   if(data == true){
                       location.href="teacher/teaDetail";
                   }else{
                       alert("用户名或密码错误！！！");
                   }
               }
