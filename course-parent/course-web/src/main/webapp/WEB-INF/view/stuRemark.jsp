...
<div class="container">
    ...
    <%--</table>--%>
            <form>
                ...
                <tr>
                    <td>${status.index + 1}、<a href="student/introduce?stuId=${post.stuId}">${post.stuName}</a>:${post.content}</td>
                    <td>
        ...
        <c:forEach items="${remarks}" var="remark">
            <form class="form-horizontal">
                <div class="form-group">
                    <label class="col-sm-2 control-label"><a>${remark.name}</a>:${remark.content}</label>
                    <div class="col-sm-10">
    ...
    $("#submit").click(function () {
        $.ajax({
            ...
            success:function (data) {
                if(data.flag == "true"){
                    location.href="remark/flush?postId="+data.message;
                }else {
                    alert("评论失败！！！");
                }
            }
