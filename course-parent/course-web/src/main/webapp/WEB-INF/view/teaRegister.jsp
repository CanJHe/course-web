...
<div class="container">
    <div class="row" >
        <div class="page-header">
            <h1>WEB课程资源库系统<small>教师注册</small></h1>
        </div>
    </div>
    ...
    <div class="row">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" ><a href="skip/skipAdminRegister">Admin</a></li>
    ...
    <form class="form-horizontal">
        ...
        <div class="form-group">
            <label for="tea_phone" class="col-sm-2 control-label">联系方式</label>
            <div class="col-sm-10">
                <input type="tel" class="form-control" id="tea_phone" name="tea_phone" placeholder="请输入联系方式">
            </div>
        </div>
        <div class="form-group">
       ...
       $("#register").click(function () {
           if ($("#name").val() == ""){
               ...
               $.ajax({
                   ...
                   type:"post",
                   dataType:"json",
                   // data:$("#tea_register").serialize(),
                   data:{
                       name:$("#name").val(),
                       password:$("#password").val(),
                       teaPhone:$("#tea_phone").val()
                   },
