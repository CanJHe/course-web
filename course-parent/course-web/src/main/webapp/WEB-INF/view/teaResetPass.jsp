...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-8">
            <form class="form-horizontal" id="tea_resetPass" >
                <input type="hidden" name="teaPhone" value="${teaPhone}">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-default" id="tea_reset">确定</button>
                    </div>
                </div>
            </form>
        </div>
